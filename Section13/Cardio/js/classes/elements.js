export default class Elements {
  static clearWorkouts = document.querySelector('#workouts-clear');
  ...
  static sortWorkouts = document.querySelector('#workouts-sort');
  static workouts = document.querySelector('.workouts');
}
